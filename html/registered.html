...
<body>
	<div class="ui menu container" id="header-principal">
		<div class="" id="home">
			<h1><a  id="LOGO" href="index.html"><i class="icon home"></i>Aprend<strong id="E">E</strong>nseñando</a></h1>	
		</div>
		<div class="item right">
			<a id="item" href="login.php"> <i class="icon user circle active" ></i> Login</a>
		</div>
		<div class="item">
			<a id="item" href="Contanto"> <i class="icon comments"></i> Contacto</a>
		</div>
		<div class="item">
			<a id="item" href="Ayuda"> <i class="icon info circle"></i> Ayuda</a>
		</div>
		<div class="item">
			<a id="item" href="opciones"><i class="icon ellipsis horizontal"></i> </a>
		</div>
	</div>
	
	<div class="ui container" style="background: rgba(242,242,242,0.9);width: 50%;padding: 20px;">
	<form action="" class="ui form">
  	<h2 class="ui dividing header pink">User Profile</h2>
	  			...
	  			<div class="field">
	  			   	...
	  			   	<div class="">
	  			   		<div class="sixteen wide field">
	  			       		<input type="email" required="required" name="usEmailAddress" placeholder="e-mail">
	  			   		</div>
	  			   	</div>
	  			</div>
	  			<div class="field">
	  				...
	  				<div class="ui fields">
	  					<div class="eight wide field">
	  			   			<input type="text" required="required" name="usFirstName" placeholder="First Name">
	  					</div>
	  					<div class="eight wide field">
	  						<input type="text" required="required" name="usLastName" placeholder="Last Name">
	  			      	</div>
	  			    </div>
	  			</div>
	  		</div>
  		...
  		<div class="field">
  			...
  			<div>
  				<div>
  					<input type="text" required="required" name="usLanguaje">
  				</div>
  			</div>
  		</div>
    	...
    	<div class="field">
  		...
  		<div class="ui button inverted pink" tabindex="0">Register</div>
		</form>
	</div>
